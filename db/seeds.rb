...
admin = User.create(name:'miriya', email:'miriya.lee@gmail.com', role:'admin')
organizer = User.create(name:'organizer', email:'organizer@gmail.com', role:'organizer')
pending = User.create(name:'pending', email:'pending@gmail.com', role:'pending')
...
event_camp2 = Event.create(title:'2nd. UX Camp Seoul', starts_at: '2011-02-26', ends_at: '2011-02-26')
...
source_path = "#{::Rails.root}/public/seed/event_photos"
...
ogc41 = OrganizerGroup.create(event_id: event_camp4.id, name: '총괄', position: 1)
ogc42 = OrganizerGroup.create(event_id: event_camp4.id, name: '진행', position: 2)
...
Organizer.create(event_id: event_camp4.id, position: 5, name:'함지혜', organizer_group_id: ogc42.id, link: 'http://www.facebook.com/profile.php?id=100000642186516')
Organizer.create(event_id: event_camp4.id, position: 6, name:'이윤경', organizer_group_id: ogc42.id, link: 'http://www.facebook.com/yoonkyeong.lee.5')
Organizer.create(event_id: event_camp4.id, position: 7, name:'백재인', organizer_group_id: ogc42.id, link: 'http://www.facebook.com/james.baeck')
Organizer.create(event_id: event_camp4.id, position: 8, name:'임정민', organizer_group_id: ogc42.id, link: 'http://www.facebook.com/ja2me')
Organizer.create(event_id: event_camp4.id, position: 9, name:'권만진', organizer_group_id: ogc43.id, link: 'http://www.facebook.com/radiostar1122')
Organizer.create(event_id: event_camp4.id, position: 10, name:'심민수', organizer_group_id: ogc43.id, link: 'http://www.facebook.com/mins.stroy')
Organizer.create(event_id: event_camp4.id, position: 11, name:'정태진', organizer_group_id: ogc44.id, link: 'http://www.facebook.com/itaijin')
Organizer.create(event_id: event_camp4.id, position: 12, name:'노수진', organizer_group_id: ogc44.id, link: 'http://www.facebook.com/sujin.roh')
Organizer.create(event_id: event_camp4.id, position: 13, name:'김병환', organizer_group_id: ogc44.id, link: 'http://www.facebook.com/kaidomo')
Organizer.create(event_id: event_camp4.id, position: 14, name:'배성환', organizer_group_id: ogc44.id, link: 'http://www.facebook.com/cake.strategy')
Organizer.create(event_id: event_camp4.id, position: 15, name:'양지영', organizer_group_id: ogc44.id, link: 'http://www.facebook.com/yang.jiyoung.3')
Organizer.create(event_id: event_camp4.id, position: 16, name:'강은정', organizer_group_id: ogc45.id)
Organizer.create(event_id: event_camp4.id, position: 17, name:'이준혁', organizer_group_id: ogc45.id, link: 'http://www.facebook.com/miriya.lee')
Organizer.create(event_id: event_camp4.id, position: 18, name:'안지혜', organizer_group_id: ogc45.id, link: 'http://www.facebook.com/jihye.an.547')
Organizer.create(event_id: event_camp4.id, position: 19, name:'최성현', organizer_group_id: ogc45.id, link: 'http://www.facebook.com/ssungH')
Organizer.create(event_id: event_camp4.id, position: 20, name:'배영하', organizer_group_id: ogc45.id, link: 'http://www.facebook.com/youngha.bae.5')
Organizer.create(event_id: event_camp4.id, position: 21, name:'강신녀', organizer_group_id: ogc45.id, link: 'http://www.facebook.com/Leopulse')

puts '== CreateOrganizers: photo uploading ======================'
source_path = "#{::Rails.root}/public/seed/organizer_photos/camp4"
candidates = Dir.glob("#{source_path}/*.*")
candidates.each do |fullpath|
  begin
    puts "--- Trying file: #{fullpath}"
...
source_path = "#{::Rails.root}/public/seed/sponsor_photos/camp4"
candidates = Dir.glob("#{source_path}/*.*")
candidates.each do |fullpath|
  begin
    puts "--- Trying file: #{fullpath}"
