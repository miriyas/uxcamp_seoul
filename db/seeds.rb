...
event_camp4 = Event.create(title:"4th. UX Camp Seoul", starts_at: "2012-07-04", ends_at: "2012-07-04")
  date = event_camp4.starts_at.strftime("%Y-%m-%d")
...
period1 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 10:00")
  Program.create(period_id: period1.id, title:"등록 및 입장(4층)")

period2 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 11:00")
  Program.create(period_id: period2.id, title:"오프닝")

period3 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 11:55")
  Program.create(period_id: period3.id, title:"점심식사 (지하 1층 푸드코드 이용)")

period4 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 13:10")
...
period5 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 14:00")
...
period6 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 14:50")
...
period7 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 15:40")
...
period8 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 16:30")
  Program.create(period_id: period8.id, title:"클로징")

period9 = Period.create(event_id: event_camp4.id, starts_at: "#{date} 17:20")
